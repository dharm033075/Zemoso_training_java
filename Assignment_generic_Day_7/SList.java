...
public class SList<T> implements slist<T>{
    ...
    public static void main(String[] args){
        ...
        System.out.println("what do want to do now: Sizeoflist(),get(position), insert(at,element),set(at, element),removeAt(at)");
        System.out.println("Enter any one digit from 1 to 5 as above order 1 is sizeOfList()");
