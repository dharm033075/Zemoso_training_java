...
public class vampire_number {
    ...
    public List<Integer> vampire_number1(){
        ...
        while(x.size()<=100){
            ...
            for(int j=(int)(Math.pow(10,i-1)+1);j<=(int)(Math.pow(10,i)-1);j++){
                ...
                if(x!=0){
                    ...
                    m=isdigit(y,n);
                    System.out.println("running is digit");
                    *System.out.println("after digit in if"+m);
                }*/
                ...
                if(m==true){
                    ...
                    if(f==true){
                        ...
                        //System.out.println(y);
                        //System.out.println("addin is done\n"+(x*y)+"\n"+countr++);
                    }
        ...
        //List<Integer> u=new ArrayList<>(ps);
                ...
                if(isdigit(number/p,digits)){
                    if(ismatching(p,number/p,digits)){
                         ...
                         break;
                           ...
                           // System.out.println(u.toString()+""+"this one");


                        //System.out.println(p+" "+number/p+"  "+p*(number/p));
    ...
    //isdigit function check if the second factor of a number have the number of digits in it is half of the number's digit
    //example like 4 digit number 1260 (factors 21,60) it will check the second factor(60) have the digit(4/2) 2 in it and return boolean
    public boolean isdigit(int fac2, int digits){
        int count=0;
        while(fac2>0){
            //System.out.println(fac2+""+digits);
            fac2=fac2/10;
        ...
        if(count==digits){
            //System.out.println("thiswas return");
            return true;
        }
        else{
            return false;
    ...
    public static void main(String[] args){
        ...
        t1.printvampnum(t1.vampire_number1());
    }
